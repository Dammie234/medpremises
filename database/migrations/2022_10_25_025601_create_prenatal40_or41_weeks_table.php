...
class CreatePrenatal40Or41WeeksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prenatal40_or41_weeks', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::dropIfExists('prenatal40_or41_weeks');
    }
}
