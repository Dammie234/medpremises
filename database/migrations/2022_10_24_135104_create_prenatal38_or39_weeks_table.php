...
class CreatePrenatal38Or39WeeksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prenatal38_or39_weeks', function (Blueprint $table) {
            $table->id('id');
    ...
    {
        Schema::dropIfExists('prenatal38_or39_weeks');
    }
}
