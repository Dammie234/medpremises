...
class CreatePrenatal32WeeksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prenatal32_weeks', function (Blueprint $table) {
            $table->id('id');
            ...
            $table->string('fansidar_doses');
            $table->date('fansidar_date');
    ...
    {
        Schema::dropIfExists('prenatal32_weeks');
    }
}
