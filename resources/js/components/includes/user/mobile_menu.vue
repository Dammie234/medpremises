            ...
            <div class="mobile-menu-bar">
                <a href="/dashboard" class="flex mr-auto">
                    <img v-if="user.role == 'Facility Manager'" alt="Logo" class="w-20"
                        :src="'../../../../' + facility.logo" />
                    <img v-else alt="Logo" class="w-20" :src="'../../../../' + staff_facility.logo" />
                </a>
                <button @click="dropdownList" id="mobile-menu-toggler">
                    <i data-feather="bar-chart-2" class="w-8 h-8 text-white transform -rotate-90"></i>
                </button>
            </div>
            <ul class="border-t border-theme-29 py-5 hidden" v-if="dropdown == true">
                <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon"><img src="https://img.icons8.com/ios/20/ffffff/medical-doctor.png" /></div>
                    ...
                    <ul class="" style="display: block" v-if="medical == true">
                        ...
                        <li v-if="user.job_type == 'Receptionist' || user.role == 'Facility Manager'">
                            <a href="/medical/patient/checkouts" class="menu">
                                <div class="menu__icon"><img
                                        src="https://img.icons8.com/ios-filled/20/ffffff/hotel-chekc-out.png" /></div>
                        ...
                        <li v-if="user.job_type == 'Medical Officer' || user.role == 'Facility Manager'">
                            <a href="/medical/discharged-patients" class="menu">
                                <div class="menu__icon"><img
                                        src="https://img.icons8.com/ios-glyphs/20/ffffff/recovery.png" /></div>
                        ...
                        <li v-if="user.role == 'Facility Manager' || user.job_type == 'Receptionist'">
                            <a href="/medical/patient-satisfactory-survies" class="menu">
                                <div class="menu__icon"><img
                                        src="https://img.icons8.com/ios/20/ffffff/customer-survey.png" /></div>
                    ...
                    <ul class="" style="display: block" v-if="lab == true">
                        <li>
                            <a href="/laboratory/medical-diagnostic-laboratory-tests" class="menu">
                                <div class="menu__icon"><img src="https://img.icons8.com/ios/20/ffffff/lab-items.png" />
                                </div>
                        ...
                        <li>
                            <a href="/laboratory/orders" class="menu">
                                <div class="menu__icon"><img
                                        src="https://img.icons8.com/windows/20/ffffff/test-results.png" /></div>
                ...
                <li v-if="(user.job_type == 'Receptionist' ||
                    ...
                    <a href="javascript:;" class="menu" @click="openRecord">
                        <div class="menu__icon"><img src="https://img.icons8.com/ios/30/ffffff/big-data.png" /></div>
                        <div class="menu__title">
                            Data Records<i class="menu__sub-icon"></i>
                        </div>
                    </a>
                    <ul class="" style="display: block" v-if="record == true">
                        <li>
                            <a href="/medical/records/death" class="menu">
                                <div class="menu__icon"><img src="https://img.icons8.com/ios/20/ffffff/skull.png" /></div>
                ...
                <li v-if="user.role == 'Facility Manager' || user.role == 'Medical Staff'"><a href="/staff/posts"
                        class="menu">
                        <div class="menu__icon"><img src="https://img.icons8.com/ios/30/ffffff/news.png" /></div>
                    ...
                    <ul class="" style="display: block" v-if="hr == true">
                        ...
                        <li>
                            <a href="/facility/hr/medical-staffs" class="menu">
                                <div class="menu__icon"><img
                                        src="https://img.icons8.com/ios/20/ffffff/medical-doctor.png" /></div>
                                <div class="menu__title">Medical Staff</div>
                            </a>
                        </li>
                        <li>
                            <a href="/facility/hr/non-medical-staffs" class="menu">
                                <div class="menu__icon"><img src="https://img.icons8.com/ios/20/ffffff/staff.png" /></div>
