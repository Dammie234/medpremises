<template>
    <div style="display:inline-block;">
        <svg width="20" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8">
            <g fill="none" fill-rule="evenodd">
                <g transform="translate(2 1)" stroke="rgb(30, 41, 59)" stroke-width="1.5">
                    <circle cx="42.601" cy="11.462" r="5" fill-opacity="1" fill="rgb(30, 41, 59)">
                    ...
                    <circle cx="49.063" cy="27.063" r="5" fill-opacity="0" fill="rgb(30, 41, 59)">
                    ...
                    <circle cx="42.601" cy="42.663" r="5" fill-opacity="0" fill="rgb(30, 41, 59)">
                    ...
                    <circle cx="11.399" cy="42.663" r="5" fill-opacity="0" fill="rgb(30, 41, 59)">
                    ...
                    <circle cx="4.938" cy="27.063" r="5" fill-opacity="0" fill="rgb(30, 41, 59)">
                    ...
                    <circle cx="11.399" cy="11.462" r="5" fill-opacity="0" fill="rgb(30, 41, 59)">
