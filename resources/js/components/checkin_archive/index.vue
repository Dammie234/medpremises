            ...
            <div class="intro-y box">
              ...
              >
                <div class="w-full xl:w-2/5">
                  <h2 class="font-medium text-base mr-auto">Patient Checkin Archive</h2>
                </div>
                ...
                <div class="w-full xl:1/5">
                  <input
                    class="form-control mr-0 xl:ml-3 xl:mt-6"
                    type="text"
                    v-model="search"
...
export default {
  ...
  methods: {
    ...
    getPatientCheckins() {
      axios
        .get("/api/v1/patient-checkins-archive/" + this.id, {
          headers: {
