        ...
        <div class="grid grid-cols-12 gap-6 mt-4">
          <div class="intro-y col-span-12 xxl:col-span-12">
            <div class="intro-y box">
              <div
                class="flex flex-col sm:flex-row gap-6 items-center p-5 border-b border-slate-200/60"
              >
                <div class="w-full xl:2/5">
                  <h2 class="font-medium text-base">Patient Visitors</h2>
                </div>
...
export default {
  ...
  methods: {
    ...
    archiveDate() {
      let date = this.date;
      this.$router.push({
        path: `/medical/visitor-archive-date/${date}`,
      });
    },
    ...
    getPatientVisitors() {
      axios
        .get("/api/v1/visitor-archive/" + this.token, {
          headers: {
