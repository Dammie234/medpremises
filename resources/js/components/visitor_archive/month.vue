              ...
              >
                <div class="w-full xl:2/5">
                  <h2 class="font-medium text-base">
                    Patient Visitors for {{ new_month | moment("MMMM YYYY") }}
                  </h2>
                </div>
...
export default {
  ...
  methods: {
    ...
    archiveMonth() {
      ...
      document.location.href = `/medical/visitor-archive-month/${month}`;
    },
    getPatientVisitors() {
      axios
        .get("/api/v1/visitor-archive-date/" + this.new_month + "/" + this.token, {
          headers: {
