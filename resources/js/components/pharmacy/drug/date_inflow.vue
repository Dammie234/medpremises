                            ...
                            <div class="grid grid-cols-12 gap-x-5 p-5 border-b border-slate-200/60">
                                <div class="col-span-12 xl:col-span-4">
                                    <h2 class="font-medium text-base mr-auto">
                                        Drug Stock Inflow Archive for {{ date | moment("Do MMMM, YYYY") }}
                                    </h2>
                                </div>
...
export default {
    ...
    methods: {
        ...
        archiveDate() {
            ...
            document.location.href = `/pharmacy/drug/inflows/dates/${date}`;
        },
        getStock() {
            this.date = this.$route.params.date;
            axios
                .get("/api/v1/drug-inflows/" + this.id + "/" + this.date, {
                    headers: {
