    ...
    <div class="main">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <top-bar title="Drug Stock Outflow Archive"></top-bar>
                <!-- END: Top Bar -->
                            ...
                            <div class="grid grid-cols-12 gap-x-5 p-5 border-b border-slate-200/60">
                                <div class="col-span-12 xl:col-span-4">
                                    <h2 class="font-medium text-base mr-auto">
                                        Drug Stock Outflow Archive for {{ month | moment("MMMM, YYYY") }}
                                    </h2>
                                </div>
                                <div class="col-span-12 xl:col-span-8">
                                    <div class="flex flex-col sm:flex-row gap-x-5">
                                        <div class="w-full flex flex-col">
                                            <label class="form-check-label ml-0" for="date">Search Drug Outflow By
                                                Date</label>
                                        ...
                                        <div class="w-full flex flex-col">
                                            <label class="form-check-label ml-0" for="month">
                                                Search Drug Outflow By Month</label>
                                            <input id="month" class="form-control mr-0" type="month" v-model="new_month"
                                                @change="archiveMonth" />
                                        </div>
                                        <div class="w-full flex flex-col" v-if="stocks.length > 2">
                                            <label class="form-check-label ml-0" for="drug">
                                                Search Drug By Name</label>
                                            <input class="form-control mr-0" id="drug" type="text" v-model="search"
...
export default {
    ...
    methods: {
        ...
        archiveMonth() {
            ...
            document.location.href = `/pharmacy/drug/outflows/months/${month}`;
        },
