    ...
    <div class="main">
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <top-bar title="Date Drug Sales"></top-bar>
                <!-- END: Top Bar -->
                            ...
                            <div class="grid grid-cols-12 gap-x-5 p-5 border-b border-slate-200/60">
                                <div class="col-span-12 xl:col-span-4">
                                    <h2 class="font-medium text-base mr-auto">
                                        Drug Sales {{ date | moment("Do MMMM, YYYY") }}
                                    </h2>
                                </div>
                                <div class="col-span-12 xl:col-span-8">
                                    <div class="flex flex-col sm:flex-row gap-x-5">
                                        <div class="w-full flex flex-col">
                                            <label class="form-check-label ml-0" for="date">Search Drug Outflows By
                                                Date</label>
                                            <input id="date" class="form-control" type="date" v-model="new_date"
                                                @change="archiveDate" placeholder="Search Drug Sells By Date" />
                                        </div>
                                        <div class="w-full flex flex-col">
                                            <label class="form-check-label ml-0" for="month">
                                                Search Drug Outflows By Month</label>
                                            <input id="month" class="form-control mr-0" type="month" v-model="month"
                                                @change="archiveMonth" placeholder="Search Drug Sells By Month" />
                                        </div>
...
export default {
    ...
    methods: {
        ...
        archiveDate() {
            ...
            document.location.href = `/pharmacy/drug/outflows/dates/${date}`;
        },

        getStock() {
            this.date = this.$route.params.date;
            axios
                .get("/api/v1/drug-outflows-date/" + this.id + "/" + this.date, {
                    headers: {
