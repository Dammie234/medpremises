                            ...
                            <div class="grid grid-cols-12 gap-x-5 p-5 border-b border-slate-200/60">
                                <div class="col-span-12 xl:col-span-4">
                                    <h2 class="font-medium text-base mr-auto">
                                        Item Inflows for {{ month | moment("MMMM, YYYY") }}
                                    </h2>
                                </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-x-5">
                                        <div class="w-full flex flex-col">
                                            <label class="form-check-label mb-2" for="drug">Search Inflow Item Archive By
                                                Date</label>
                                            <input id="drug" class="form-control" type="date" v-model="date"
                                        ...
                                        <div class="w-full flex flex-col">
                                            ...
                                            <input id="month" class="form-control" type="month" v-model="new_month"
                                        ...
                                        <div class="w-full flex flex-col" v-if="stocks.length > 5">
                                            ...
                                            <input class="form-control" type="text" id="name" v-model="search"
...
export default {
    ...
    methods: {
        ...
        archiveDate() {
            this.$router.push({
                path: `/pharmacy/item/inflows/dates/${this.date}`,
            });
        },
        archiveMonth() {
