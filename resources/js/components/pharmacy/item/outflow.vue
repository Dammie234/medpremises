<template>
    <div class="main">
        ...
        <div class="flex">
            ...
            <div class="content">
                <!-- BEGIN: Top Bar -->
                <top-bar title="Item Stock Outflows"></top-bar>
                <!-- END: Top Bar -->
                    ...
                    <div class="intro-y col-span-12 xxl:col-span-12 xl:col-span-12">
                        <div class="intro-y box">
                            <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60">
                                <h2 class="font-medium text-base mr-auto">Item Stock Outflows</h2>
                                <div class="w-full sm:w-auto sm:ml-auto xl:w-auto xl:ml-auto mt-3 sm:mt-0">
                                    <label class="form-check-label ml-0 pl-2" for="date">Search Item Outflow By Date</label>
                                    <input id="date" class="form-control mr-0 ml-3" type="date" v-model="date"
                                        @change="archiveDate" />
                                </div>
                                <div class="w-full sm:w-auto sm:ml-auto xl:w-auto mt-3 xl:ml-auto sm:mt-0">
                                    <label class="form-check-label ml-0" for="month">
                                        Search Outflow Item Archive By Month</label>
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-x-5">
                                    <div class="col-span-12 xl:col-span-12" v-if="stocks.length > 5">
                                        <input class="form-control mr-0" id="item" type="text" v-model="search"
...
export default {
    ...
    methods: {
        ...
        archiveDate() {
            let date = this.date;
            this.$router.push({
                path: `/pharmacy/item/outflows/dates/${date}`,
            });
        },
        archiveMonth() {
        ...
        getStock() {
            axios
                .get("/api/v1/item-outflows/" + this.id, {
                    headers: {
