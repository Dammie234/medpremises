        ...
        <div class="grid grid-cols-12 gap-6 mt-4">
          <div class="intro-y col-span-12 xxl:col-span-12">
            <div class="intro-y box">
              ...
              >
                <h2 class="font-medium text-base mr-auto">Prenatal Admissions</h2>

                <div class="w-full flex flex-row sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                  <router-link
                    :to="{ name: 'create-prenatal-admission' }"
                    class="btn btn-primary"
                    >Prenatal/Antenatal Admission</router-link
                  >
                  <input
              ...
              <div class="p-5">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody class="text-xs">
                      <tr v-for="prenatal in filterSearch" :key="prenatal.id">
                        ...
                        <td>
                          <span v-if="prenatal.prenatal">Attended</span
                          ><span v-else>Not Attended</span>
                        </td>

                        <td>{{ prenatal.created_at | moment("from", "now") }}</td>
                        <td>
                          <router-link
                            v-if="prenatal.active"
                            :to="{
                          ...
                          <router-link
                            :to="{
                              name: 'prenatal-admission',
                              params: { key: prenatal.key },
                            }"
                            class="btn btn-primary btn-sm mr-2"
                            ><i class="fa fa-info mr-2"></i> Show</router-link
                          >
                          <router-link
                            v-if="prenatal.prenatal == true"
                            :to="{ name: 'prenatal', params: { key: prenatal.key } }"
                            class="btn btn-primary btn-sm"
                            >Prenatal Details</router-link
                          >
                          <router-link :to="{name: 'pregnancy-outcome', params:{key: prenatal.key}}" class="btn btn-sm btn-primary">Delivery, Pregnancy &amp; Maternal Outcome</router-link>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div v-else>
                  ...
                  >
                    ...
                    ></i>
                    <strong class="mr-2"> Whoops! </strong> There are no admitted
                    prenatals yet.
                    <button
                      type="button"
                      class="btn-close"
...
export default {
  ...
  methods: {
    ...
    getAdmittedPrenatals() {
      axios
        .get("/api/v1/get-admitted-prenatals/" + this.token, {
          headers: {
