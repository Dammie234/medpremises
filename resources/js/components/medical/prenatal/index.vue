            ...
            <div class="intro-y box">
              ...
              >
                ...
                <div class="w-full flex flex-row sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                  <router-link :to="{ name: 'create-prenatal' }" class="btn btn-primary"
                    >Register Patient</router-link
                  >
                  <input
              ...
              <div class="p-5">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody class="text-xs">
                      <tr v-for="prenatal in filterSearch" :key="prenatal.id">
                        ...
                        <td>
                          <router-link
                            :to="{ name: 'edit-prenatal', params: { key: prenatal.key } }"
                            class="btn btn-primary mr-3 mt-2 btn-sm"
                            title="Edit Prenantal"
                          ...
                          ><router-link
                            ...
                            class="btn btn-primary mr-3 mt-2 btn-sm"
                            ><i class="fa fa-map-marker mr-2"></i> Visits</router-link
                          >
                          <router-link
                            :to="{
                            ...
                            title="Lactation Interview"
                            class="btn btn-primary mr-3 mt-2 btn-sm"
                            ><i class="fa fa-map-marker mr-2"></i>Lactation
                ...
                <div v-else>
                  ...
                  >
                    ...
                    ></i>
                    <strong class="mr-2"> Whoops! </strong> There are no registered
                    prenatals yet.
                    <button
                      type="button"
                      class="btn-close"
...
export default {
  ...
  methods: {
    ...
    getPrenatals() {
      axios
        .get("/api/v1/prenatals/" + this.token, {
          headers: {
