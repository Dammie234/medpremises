              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    Create 34/36 week Prenantal/Antenatal Visit for {{ data.prenatal.name }}
                  </h2>
                ...
                <div class="p-5">
                  <form class="grid grid-cols-12 gap-6" @submit.prevent="submit">
                    ...
                    <div class="col-span-12 xl:col-span-4 mt-2">
                        <label for="tt_doses" class="form-label"
                          >Tetanus Toxoid (TT) Doses</label
                        >
                        <select
                          id="tt_doses"
                          class="form-control"
                      ...
                      <div class="col-span-12 xl:col-span-4 mt-2">
                        <label for="tt_date" class="form-label"
                          >Tetanus Toxoid (TT) Date</label
                        >
                        <input
                          id="tt_date"
                          type="date"
