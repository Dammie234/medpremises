              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    34/36 Week Prenatal Visit Information for {{ data.prenatal.name }}
                  </h2>
                    ...
                    <table class="table table-bordered">
                      <tr>
                        <td class="text-md">
                          ...
                          >{{ data.prenatal_34_36_week.blood_pressure }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Tummy Measurement</strong
                          >{{ data.prenatal_34_36_week.tummy_measurement }}
                        </td>
                        <td class="text-md">
                            <strong class="uppercase block text-xs">Baby Heartbeat</strong
                            >{{ data.prenatal_34_36_week.baby_heartbeat }}
                          </td>
                        <td class="text-md">
                            <strong class="uppercase block text-xs">Health Status</strong
                            >{{ data.prenatal_34_36_week.health_status }}
                          </td>
                          <td class="text-md">
                            <strong class="uppercase block text-xs">Tetanus Toxoid (TT) Doses</strong
                            >{{ data.prenatal_34_36_week.tt_doses }}
                          </td>
                      </tr>
                      <tr>
                        <td class="text-md">
                            <strong class="uppercase block text-xs">Tetanus Toxoid (TT) Date</strong
                            >{{ data.prenatal_34_36_week.tt_date | moment("dddd Do MMMM YYYY") }}
                          </td>
  
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Gestational Age</strong
                          >{{ data.prenatal_34_36_week.gestational_age }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs"
                            >Haemogloblin Result</strong
                          >{{ data.prenatal_34_36_week.haemoglobin_result }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Antenatal Risk</strong
                          >{{ data.prenatal_34_36_week.antenatal_risk }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Fetal Heart Rate</strong
                          >{{ data.prenatal_34_36_week.fetal_heart_rate }}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-md">
                          ...
                          >{{ data.prenatal_34_36_week.tocolysis }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs"
                            >Induction of Labour</strong
                          >{{ data.prenatal_34_36_week.induction_of_labour }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Blood Transfusion</strong
                          >{{ data.prenatal_34_36_week.blood_transfusion }}
                        </td>
                        <td class="text-md"></td>
                        <td></td>
                      </tr>
