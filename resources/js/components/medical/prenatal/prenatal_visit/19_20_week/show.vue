            ...
            <div class="intro-y box">
              ...
              >
                <h2 class="font-medium text-base mr-auto">
                  19/20 Week Prenatal Visit Information for {{ data.prenatal.name }}
                </h2>
                  ...
                  <table class="table table-bordered">
                    <tr>
                      <td class="text-md">
                        ...
                        >{{ data.prenatal_19_20_week.blood_pressure }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Tummy Measurement</strong
                        >{{ data.prenatal_19_20_week.tummy_measurement }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs"
                          >Type of ultrasound scan</strong
                        >{{ data.prenatal_19_20_week.type_of_ultrasound_scan }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Scan Result</strong
                        >{{ data.prenatal_19_20_week.scan_result }}
                      </td>
                    </tr>
                    <tr>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Health Status</strong
                        >{{ data.prenatal_19_20_week.health_status }}
                      </td>

                      <td class="text-md">
                        <strong class="uppercase block text-xs">Gestational Age</strong
                        >{{ data.prenatal_19_20_week.gestational_age }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs"
                          >Haemogloblin Result</strong
                        >{{ data.prenatal_19_20_week.haemoglobin_result }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Antenatal Risk</strong
                        >{{ data.prenatal_19_20_week.antenatal_risk }}
                      </td>
                    </tr>
                    <tr>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Fetal Heart rate</strong
                        >{{ data.prenatal_19_20_week.fetal_heart_rate }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Tocolysis</strong
                        >{{ data.prenatal_19_20_week.tocolysis }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs"
                          >Induction of Labour</strong
                        >{{ data.prenatal_19_20_week.induction_of_labour }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Blood Transfusion</strong
                        >{{ data.prenatal_19_20_week.blood_transfusion }}
                      </td>
