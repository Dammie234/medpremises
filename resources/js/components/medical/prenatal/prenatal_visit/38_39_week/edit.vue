              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    Edit 38/39 week Prenantal/Antenatal Visit for {{ data.prenatal.name }}
                  </h2>
    ...
    methods: {
      ...
      getPrenatal38Or39Week() {
        axios
          ...
          .then((response) => (this.form = response.data.prenatal_38_39_week))
          .catch((error) => {
            console.log(error);
            if (error.response.status == 401) {
              this.$router.push({
      ...
      submit() {
        this.loading = true;
        axios
          .patch("/api/prenatal-38-39-week/" + this.key, this.form)
          .then(() => {
            this.$router.push({
            ...
            Toast.fire({
              icon: "success",
              title: "Prenatal 38/39 week updated successfully",
            });
          })
