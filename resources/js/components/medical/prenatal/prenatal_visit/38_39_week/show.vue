              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    38/39 Week Prenatal Visit Information for {{ data.prenatal.name }}
                  </h2>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td class="text-md">
                          ...
                          >{{ data.prenatal_38_39_week.fetal_heart_rate }}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-md">
                          ...
                          >{{ data.prenatal_38_39_week.tocolysis }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs"
                            >Induction of Labour</strong
                          >{{ data.prenatal_38_39_week.induction_of_labour }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Blood Transfusion</strong
                          >{{ data.prenatal_38_39_week.blood_transfusion }}
                        </td>
                        <td class="text-md"></td>
                        <td></td>
                      </tr>
