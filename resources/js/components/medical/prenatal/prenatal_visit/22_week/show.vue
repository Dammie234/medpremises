              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    22 Week Prenatal Visit Information for {{ data.prenatal.name }}
                  </h2>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                        ...
                        <td class="text-md">
                          ...
                          >{{ data.prenatal_22_week.induction_of_labour }}
                        </td>
                        <td class="text-md">
                          <strong class="uppercase block text-xs">Blood Transfusion</strong
                          >{{ data.prenatal_22_week.blood_transfusion }}
                        </td>
                        <td class="text-md"></td>
                        <td></td>
                      </tr>
