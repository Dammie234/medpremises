              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    Edit 28 week Prenantal/Antenatal Visit for {{ data.prenatal.name }}
                  </h2>
    ...
    methods: {
      ...
      getPrenatal28Week() {
        axios
          ...
          .then((response) => (this.form = response.data.prenatal_28_week))
          .catch((error) => {
            console.log(error);
            if (error.response.status == 401) {
              this.$router.push({
      ...
      submit() {
        this.loading = true;
        axios
          .patch("/api/prenatal-28-week/" + this.key, this.form)
          .then(() => {
            this.$router.push({
            ...
            Toast.fire({
              icon: "success",
              title: "Prenatal 28 week updated successfully",
            });
          })
