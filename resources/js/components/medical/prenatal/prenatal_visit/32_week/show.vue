            ...
            <div class="intro-y box">
              ...
              >
                <h2 class="font-medium text-base mr-auto">
                  32 Week Prenatal Visit Information for {{ data.prenatal.name }}
                </h2>
                  ...
                  <table class="table table-bordered">
                    <tr>
                      <td class="text-md">
                        ...
                        >{{ data.prenatal_32_week.blood_pressure }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Tummy Measurement</strong
                        >{{ data.prenatal_32_week.tummy_measurement }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Baby Heartbeat</strong
                        >{{ data.prenatal_32_week.baby_heartbeat }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Health Status</strong
                        >{{ data.prenatal_32_week.health_status }}
                      </td>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Fansidar Doses</strong
                        >{{ data.prenatal_32_week.fansidar_doses }}
                      </td>
                    </tr>
                    <tr>
                      <td class="text-md">
                        <strong class="uppercase block text-xs">Fansidar Date</strong
                        >{{
                          data.prenatal_32_week.fansidar_date
