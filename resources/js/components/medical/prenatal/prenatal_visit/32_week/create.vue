              ...
              <div class="intro-y box">
                ...
                >
                  <h2 class="font-medium text-base mr-auto">
                    Create 22 week Prenantal/Antenatal Visit for {{ data.prenatal.name }}
                  </h2>
                ...
                <div class="p-5">
                  <form class="grid grid-cols-12 gap-6" @submit.prevent="submit">
                    ...
                    <div class="col-span-12 xl:col-span-4 mt-2">
                        <label for="fansidar_doses" class="form-label"
                          >Fansidar Doses</label
                        >
                        <select
                          id="fansidar_doses"
                          class="form-control"
                      ...
                      <div class="col-span-12 xl:col-span-4 mt-2">
                        <label for="fansidar_date" class="form-label"
                          >Fansidar Date</label
                        >
                        <input
                          id="fansidar_date"
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        this.loading = true;
        axios
          .post("/api/prenatal-32-week/", this.form)
          .then(() => {
            this.$router.push({
            ...
            Toast.fire({
              icon: "success",
              title: "Prenatal 32 week added successfully",
            });
          })
