                      ...
                      <div class="col-span-12 xl:col-span-12">
                        ...
                        <form @submit.prevent="submit">
                          <div :disabled="loading">
                            ...
                            <div class="col-span-12 mt-3">
                              <h4 class="text-xl">Patient Discharge Instructions</h4>
                              <p class="mt-1">
                                Select any of the patient discharge instructions you will
                                like the patient to follow. You can select more than one.
                              </p>
                            </div>
                            <div class="col-span-12 mt-3 xl:col-span-12">
                              <div class="grid grid-cols-12 gap-x-5">
                                  ...
                                  <div class="flex flex-col sm:flex-row mt-2">
                                    <div class="form-check mr-2">
                                      <input
                                        ...
                                        v-model="discharge_instructions[index]"
                                        :value="index"
                                      />
...
export default {
  ...
  methods: {
    ...
    getDischargePlanningChecklist() {
      axios
        .get("/api/v1/discharge-planning-checklist/" + this.key, {
          headers: {
            Authorization: "Bearer " + this.token,
            Accept: "application/json",
          },
    ...
    submit() {
      ...
      this.form.discharge_instructions = this.discharge_instructions;
      axios
        .patch("/api/discharge-planning-checklist/" + this.key, this.form)
        .then(() => {
          this.$router.push({
