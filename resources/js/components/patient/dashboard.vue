<template>
  <div class="main">
    ...
    <div class="flex">
      <!-- BEGIN: Side Menu -->
      <patient-side-menu page="dashboard"></patient-side-menu>
      <!-- END: Side Menu -->
      <!-- BEGIN: Content -->
      <div class="content">
        <!-- BEGIN: Top Bar -->
        <patient-top-bar title="Dashboard"></patient-top-bar>
        <!-- END: Top Bar -->
                ...
                <div v-if="user.role == 'Patient'">
                  ...
                  >
                    ...
                    >
                      ...
                      continue. To edit,
                      <a href="/patient/profile/edit"> click here </a>
                      <button
                        type="button"
                        class="btn-close"
                ...
                <div class="mt-5">
                  ...
                  <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                      ...
                      <div class="ml-4 mr-auto">
                        <div class="font-medium">Robert De Niro</div>
                        <div class="text-gray-600 text-xs mt-0.5">3 December 2020</div>
                      </div>
                      <div
                        class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                      >
                  ...
                  <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                      ...
                      <div class="ml-4 mr-auto">
                        ...
                        <div class="text-gray-600 text-xs mt-0.5">2 November 2022</div>
                      </div>
                      <div
                        class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                      >
                  ...
                  <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                      ...
                      <div class="ml-4 mr-auto">
                        ...
                        <div class="text-gray-600 text-xs mt-0.5">24 December 2020</div>
                      </div>
                      <div
                        class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium"
                      >
                          ...
                          <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                title="Uploaded at 23 August 2022"
                              />
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                                ...
                                title="Uploaded at 11 January 2021"
                              />
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                          ...
                          <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                                ...
                                title="Uploaded at 12 November 2021"
                              />
                            </div>
                          </div>
                        </td>
                          ...
                          <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                title="Uploaded at 2 November 2022"
                              />
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                                ...
                                title="Uploaded at 19 August 2022"
                              />
                            </div>
                          </div>
                        </td>
                          ...
                          <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                title="Uploaded at 24 December 2020"
                              />
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                                ...
                                class="tooltip rounded-full"
                                src="dist/images/preview-1.jpg"
                                title="Uploaded at 8 November 2021"
                              />
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                              <img
                                ...
                                title="Uploaded at 25 December 2020"
                              />
                            </div>
                          </div>
                        </td>
                  ...
                  <div class="mt-5">
                    ...
                    <div class="intro-x">
                      <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                        ...
                        <div class="ml-4 mr-auto">
                          <div class="font-medium">Angelina Jolie</div>
                          <div class="text-gray-600 text-xs mt-0.5">6 April 2021</div>
                        </div>
                        <div class="text-theme-9">+$177</div>
                      </div>
                    </div>
                    <a
                      href=""
                    ...
                    <div class="intro-x relative flex items-center mb-3">
                      ...
                      <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        ...
                        <div class="text-gray-600 mt-1">
                          Has changed
                          <a class="text-theme-1 dark:text-theme-10" href="">Nikon Z6</a>
...
export default {
  ...
  methods: {
    ...
    getBiodata() {
      axios
        .get("/api-patient/v1/biodata/" + this.token, {
          headers: {
