              ...
              >
                <div class="w-full lg:w-1/2">
                  <h2 class="font-medium text-base mr-auto">
                    {{ result.patient.name }} Medical Diagnostic &amp; Laboratory Result
                  </h2>
                </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              ...
                              <div v-html="result.patient.test_result"></div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
export default {
  ...
  methods: {
    ...
    getPatient() {
      ...
      axios
        .get("/api-patient/v1/prenatal-medical-laboratory-test/" + id, {
          headers: {
