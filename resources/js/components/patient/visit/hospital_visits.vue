<template>
  <div class="main">
    ...
    <div class="flex">
      ...
      <div class="content">
        <!-- BEGIN: Top Bar -->
        <patient-top-bar title="Previous Hospital Visits"></patient-top-bar>
        <!-- END: Top Bar -->
            ...
            <div class="intro-y box">
              ...
              >
                <h2 class="font-medium text-base mr-auto">
                  {{ patient.name }} Previous Hospital Visits
                </h2>
                  ...
                  <div class="col-span-12 xl:col-span-12 mt-3">
                          ...
                          <tbody>
                            ...
                            >
                              ...
                              <td>
                                ...
                                <router-link
                                  :to="{
                                    name: 'edit-discharge-planning-checklist-patient',
                                    params: { key: consultation.key },
                                  }"
                                ...
                                <router-link
                                  v-if="!consultation.satisfactory_survey"
                                  class="btn btn-primary mt-1"
                                  :to="{
                                    name: 'patient-satisfactory-survey',
                                    params: { key: consultation.key },
                                  }"
                                  >Patient Satisfactory Survey</router-link
                                >
                              </td>
                            </tr>
                          </tbody>
                    ...
                    <div v-else>
                      ...
                      >
                        ...
                        <strong class="mr-2"> Whoops! </strong> There are no hospital visits yet!
                        <button
                          type="button"
                          class="btn-close"
...
export default {
  ...
  methods: {
    ...
    getPreviousConsultations() {
      axios
        .get("/api-patient/v1/patient-previous-consultations/" + this.id, {
          headers: {
